const globalConfig = {
  ...
  CHAT_INPUT_PLACEHOLDER: 'Type your question, eg. "What does DRI mean?"',
  ...
  HIDE_THOUGH_PROCESS_BUTTON_LABEL_TEXT: 'Hide citations',
  ...
  BRANDING_HEADLINE: 'Welcome to <Company>',
...
const teaserListTexts = {
  ...
  HEADING_CHAT: 'Chat with our assistant',
  HEADING_ASK: 'Ask a question',
  DEFAULT_PROMPTS: [
    {
      description: 'How can I start onboarding?',
    },
    {
      description: 'How do I create a PR?',
    },
    {
      description: 'How do I run our code?',
    },
  ],
};
